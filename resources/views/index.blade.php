...
<html lang="pt-br" data-bs-theme="auto">
  <head>
    ...
    <link rel="icon" href="{{ asset('icones/icone-gestao.png') }}" sizes="32x32" type="image/png">
    ...
    <link rel="icon" href="{{ asset('icones/icone-gestao.png')}} ">
...
<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <m!ain class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        @yield('content')     
      </m!ain>
    </div>
  </div>
